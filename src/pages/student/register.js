...
class App extends React.Component {
  ...
  onSubmitLogin = (e) => {
    ...
    axios
      .post(`${process.env.BACKEND_API_AZURE}/student/login`, {
        sliitEmail,
        password,
      })
      .then((response) => {
  ...
  onSubmitRegister = (e) => {
    ...
    axios
      .post(`${process.env.BACKEND_API_AZURE}/student/`, {
        fullName,
        sliitId,
        sliitEmail,
        personalEmail,
            ...
            <div className="row align-items-center">
              ...
              <div className={this.state.register}>
                <div className="card">
                  ...
                  <div className="card-body p-lg-5">
                    <h3 className="mb-4">
                      Get starte with your research project
                    </h3>
                    <p className="text-muted text-sm mb-5">
                      Please fill your correct detail and create your account to
                      continue you research project.
                    </p>
                        ...
                        <div className="col-lg-6">
                          <div className="form-floating mb-3">
                            <input
                              ...
                              id="fullName"
                              type="text"
                              placeholder="Isuru Pathum Herath"
                              pattern="^[a-zA-Z]{2,40}( [a-zA-Z]{2,40})+$"
                              title="Invalid Input for Full Name"
                              required
                            />
                        ...
                        <div className="col-lg-6">
                          <div className="form-floating mb-3">
                            <input
                              className="form-control"
                              onChange={this.onChange}
                              value={this.state.sliitId}
                              id="sliitId"
                              type="text"
                              placeholder="IT12345678"
                              pattern="[A-Za-z0-9]{10}"
                              title="Invalid Studnt Number."
                              required
                            />
              ...
              <div className="col-lg-6 col-xl-5 ms-xl-auto px-lg-4 text-center text-primary">
                <div className={this.state.details}>
                  ...
                  <p className="lead text-muted">
                    Make your project Team easily with get the pre-aproval from
                    your Lecture in Charge on few clicks!
                  </p>
                </div>
              </div>
            </div>
